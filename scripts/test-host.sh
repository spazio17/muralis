...
# auth throttle, system stats, recycle policy, server probe policy, outage
# ledger, escape sequence and telemetry interval.
...
for name in KioskCommandDispatcher SystemStats RecyclePolicy ServerProbePolicy \
            OutageLedger EscapeSequence KioskRuntimeState Provisioning RequestOrigin \
            AuthThrottle; do
